...
try:
    from src.api.services.geoip_lookup import GeoIPLookupService
except ImportError:
...
class GeoFencingService:
    ...
    def get_geographic_stats(self, start_time: datetime) -> Dict:
        ...
        return {
            ...
            for country_code, total, blocked in stats
        }
